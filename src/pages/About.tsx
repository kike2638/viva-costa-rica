      ...
      <div className="mt-8 bg-white border border-stone-200 rounded-2xl p-6 grid md:grid-cols-2 gap-6">
        <div>
          ...
          <ul className="text-sm text-stone-600 mt-2 space-y-1 list-disc list-inside">
            <li>Propiedades verificadas en San Ramón, Occidente y GAM</li>
        ...
        <div>
          ...
          <p className="text-sm text-stone-600 mt-2 leading-relaxed">Base San Ramón de Alajuela. El portal nace para dar trazabilidad digital a tu patrimonio: presupuesto transparente desde San Ramón, avalúo GRATIS si envías fotos/datos y con desplazamiento solo tras pago.</p>
        </div>
      </div>
