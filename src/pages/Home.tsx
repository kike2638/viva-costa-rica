    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://placehold.co/1920x900/1a120e/d4a574?text=VIVA+COSTA+RICA+Hero" alt="hero" className="w-full h-full object-cover"/>
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-14 md:py-20">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <motion.div initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.6}}>
              <span className="inline-flex items-center gap-2 bg-white/10 border border-white/20 backdrop-blur text-white text-xs font-semibold px-3 py-1.5 rounded-full"><ShieldCheck className="w-4 h-4 text-[#d4a574]"/> Certified Appraisals & Investments · 98.7% precisión · Viva Costa Rica</span>
              ...
              <p className="text-stone-200 mt-4 text-[15px] leading-relaxed max-w-xl">Viva Costa Rica — el portal inmobiliario más confiable de Costa Rica. Encuentra tu próxima propiedad o solicita un avalúo certificado con trazabilidad real en menos de 24 horas.</p>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex items-end justify-between gap-4 mb-6">
          <div><h2 className="text-2xl font-extrabold text-stone-900">Propiedades destacadas</h2><p className="text-sm text-stone-500">Selección curada por Viva Costa Rica</p></div>
      ...
      <section className="bg-stone-50 border-y border-stone-200">
        <div className="max-w-7xl mx-auto px-4 py-12 grid lg:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <p className="text-stone-600 mt-3 text-sm leading-relaxed">Tasadores certificados Viva Costa Rica realizan estudio comparativo, inspección física y análisis legal para entregarte un avalúo comercial real, no una estimación automática. Todo queda registrado en el panel SuperAdmin.</p>
