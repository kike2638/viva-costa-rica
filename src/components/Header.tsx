...
import { Menu, X, Mountain, Phone, Heart, Search, Shield } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-[68px] gap-4">
          <Link to="/" className="flex items-center gap-3 shrink-0">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#8c6239] to-[#4a3320] flex items-center justify-center text-white shadow">
              <Mountain className="w-5 h-5"/>
            </div>
            <div className="leading-tight">
              <div className="font-extrabold text-[#1a120e] tracking-tight text-[17px]">TERRA<span className="text-[#a67c52]"> CAPITAL</span></div>
              <div className="text-[11px] tracking-[0.18em] text-stone-500 font-semibold -mt-1">SAN RAMÓN · AVALÚOS</div>
            </div>
          </Link>
